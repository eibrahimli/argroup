    ...
    <!-- DATA TABLE-->
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="title-5 m-b-35">Xidmət kateqoriyaları</h3>
<?php 
...
$update = mysqli_query($conn, "UPDATE `service_cats` set
`name_az` = '$name_az',
`name_en` = '$name_en', 
...
if(isset($_POST['sil'])){
    ...
    $sil = mysqli_query($conn, "DELETE FROM `service_cats` where id = $id");
    ?>
                            ...
                            <div class="table-responsive table-responsive-data2">
                                <table class="table table-data2">
                                    ...
                                    <tbody>
                                       ...
                                       <?php 
                    $partners = mysqli_query($conn, "SELECT * FROM `service_cats` order by id DESC");
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                             <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Xidmət kateqoriyası kodu</label>
                                                </div>
