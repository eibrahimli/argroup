...
$newFileName = "homebanner".$id . '.' . $fileExtension;
...
$uploadFileDir = ''.$sitefolder.'img/bannerx/';
...
header("Location: backslayder.php");
}
?>
 ...
 <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
               <a href="backslayder.php"  style="background: #b9b9b9; padding: 5px 15px 5px 15px;"> GERİ</a>
                &emsp;
      ...
      <img src="../img/bannerx/homebanner<?= $id; ?>.jpg" width="500px;">
            <section>
