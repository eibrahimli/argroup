...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link href="css/font-face.css" rel="stylesheet" media="all">
        <link href="css/4.css" rel="stylesheet" media="all">
...
<link href="https://fonts.googleapis.com/css2?family=Crimson+Pro:wght@500&family=Poppins:ital,wght@0,100;0,200;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
                        ...
                        <li class=" has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                 ...
                                 <li>
                                    <a href="product_cats.php">
                                       <i class="fas fa-plus"></i>Məhsul kateqoriyaları</a>
                                </li>
                                 <li>
                                    <a href="add_product_cat.php">
                                       <i class="fas fa-plus"></i>Məhsul kateqoriyası əlavə et</a>
                                </li>
                            ...
                            <div class="header-button2">
                                ...
                                <div class="setting-menu js-right-sidebar d-none d-lg-block">
                                    <div class="account-dropdown__body">
                                        ...
                                        <div class="account-dropdown__item">
                                            <a href="tags.php">
                                                <i class="zmdi zmdi-settings"></i>SEO etiketlər</a>
                                        </div>
...
<li >
            ...
            <!-- END HEADER DESKTOP-->
              <!-- BREADCRUMB-->
            <section class="au-breadcrumb m-t-75" style="background: #000; border-radius: 0px 0px 0px 10px;">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                              ...
                              <h1 id='pagetitle' style='color: white;'></h1>
                                    </div>
                                     <button id="addbtn" class='btn btn-light'></button>
