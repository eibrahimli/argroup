                ...
                <div class="container">
                    <div class="banner_content text-center">
                        ...
                        <div class="page_link">
                            ...
                            <a href="news.php"><?php echo $pg['title_'.$lang.'']; ?></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="blog_categorie_area">
            <div class="container">
                <div class="row">
                    ...
                    ?>
                    <div class="col-lg-4">
                            <a href="news.php?c=<?php echo $xeber_cat3['id']; ?>">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        ...
                                        <div class="blog_details">
                                            <a href="post.php?id=<?php echo $xeber['id']; ?>"><h2><?php echo $xeber['header_'.$lang.'']; ?></h2></a>
                                            <p><?php echo $xeber['text_'.$lang.'']; ?></p>
                                            <a href="post.php?id=<?php echo $xeber['id']; ?>" class="blog_btn"><?php echo $l['44']; ?></a>
                                        </div>
                                    </div>
                                </div>
                            </article>
