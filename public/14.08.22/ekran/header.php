          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
              <ul class="nav navbar-nav menu_nav ml-auto">
                   <li class="nav-item"><a class="nav-link" href="<?= $siteurl ?>"><?php echo $l[2]; ?></a></li>
...
<li class="nav-item submenu dropdown">
                  <a href="<?= $siteurl ?>xidmetler" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $l[120]; ?></a>
...
while($brw = mysqli_fetch_array($brtap)){ ?>
                    <li class="nav-item"><a class="nav-link" href="xidmetler/<?= seo($brw['name_'.$lang.''])."/".$brw['id']; ?>"><?php echo $brw['name_'.$lang.'']; ?></a></li>
<?php } ?>
 <li class="nav-item"><a class="nav-link" href="<?= $siteurl ?>xidmetler"><?php echo $l[200]; ?></a></li>
                ...
                <li class="nav-item submenu dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= $siteurl ?>layiheler/"><?php echo $l[37]; ?></a></li>
                  
                  </ul>
                </li> 
                
                <li class="nav-item"><a class="nav-link" href="brendler"><?php echo $l[193]; ?></a></li>
                                <li class="nav-item submenu dropdown">
                  <a href="<?= $siteurl ?>mehsullar" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $l[199]; ?></a>
                  <ul class="dropdown-menu" style='min-width: 350px'>
               <?php $brtap = mysqli_query($conn, "SELECT * FROM `product_cats`");
while($brw = mysqli_fetch_array($brtap)){ ?>
                    <li class="nav-item"><a class="nav-link" href="mehsullar/<?= seo($brw['name_'.$lang.''])."/".$brw['id']; ?>"><?php echo $brw['name_'.$lang.'']; ?></a></li>
<?php } ?>
 <li class="nav-item"><a class="nav-link" href="<?= $siteurl ?>mehsullar"><?php echo $l[201]; ?></a></li>
