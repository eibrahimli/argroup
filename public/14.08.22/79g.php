...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Gallery with wave transition effect.</title>
  <link href="https://fonts.googleapis.com/css?family=Yanone+Kaffeesatz" rel="stylesheet"><link rel="stylesheet" href="x9_photo_gallery/style.css">
...
"<?= $siteurl ?>img/gallery/<?= $photo['photo']; ?>",
<?php } ?>
  ];
