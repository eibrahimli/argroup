    ...
    <!-- DATA TABLE-->
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="title-5 m-b-35"><?php echo$l[22];?></h3>
<?php 
...
$update = mysqli_query($conn, "UPDATE `locations` set
`country` = '$country',
`address` = '$address',
`phone` = '$phone',
`phone2` = '$phone2'
...
if(isset($_POST['sil'])){
    ...
    $sil = mysqli_query($conn, "DELETE FROM `locations` where id = $id");
     ?>
                                ...
                                <table class="table table-data2">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ID</th>
                                            <th><?php echo$l[101];?></th>
                                           <th><?php echo$l[102];?></th>
                                            <th><?php echo$l[103];?></th>
                                            <th><?php echo$l[103];?> 2</th>
                                    ...
                                    <tbody>
                                       ...
                                       <?php 
                    $locations = mysqli_query($conn, "SELECT * FROM `locations` order by id DESC");
                    while($location = mysqli_fetch_array($locations)){
                             ...
                             ?>
                                 <tr class="tr-shadow">
                                            ...
                                            <td> <?php echo $location['phone2']; ?> </td>
                                            
                                            <td>
                                                <div class="table-data-feature">
                                                   
                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="zmdi zmdi-edit" data-toggle="modal" data-target="#largeModal<?php echo $location['id']; ?>"></i>
                                                    </button>
...
data-toggle="modal" data-target="#staticModal<?php echo $location['id']; ?>" title="Delete">
            ...
            <!-- modal large -->
            <div class="modal fade" id="largeModal<?php echo $location['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="largeModalLabel"><?php echo $location['id']; ?></h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                             <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label"><?php echo $l[104]; ?></label>
                                                </div>
                                              ...
                                              <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" value="<?php echo $location['country']; ?>"  class="form-control" name="country">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" value="<?php echo $location['address']; ?>"  class="form-control" name="address">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" value="<?php echo $location['phone']; ?>"  class="form-control" name="phone">
                                               ...
                                               <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" value="<?php echo $location['phone2']; ?>"  class="form-control" name="phone2">
