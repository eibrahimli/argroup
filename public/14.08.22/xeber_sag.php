 <div class="col-lg-4">
                             ...
                             ?>
                                ...
                                <div class="media post_item">
                                    ...
                                    <div class="media-body">
                                        <a href="xeber/<?= seo($xeber3['header_'.$lang.'']).'/'.$xeber3['id']; ?>"><h3><?php echo $xeber3['header_'.$lang.'']; ?></h3></a>
                        ...
                        -->
                            ...
                            while($xeber_c = mysqli_fetch_array($xeber_cats)){
                             ...
                             ?>
                                    <li>
                                        <a href="xeberler/<?= seo($xeber_c['name_'.$lang.'']).'/'.$xeber_c['id']; ?>" class="d-flex justify-content-between">
