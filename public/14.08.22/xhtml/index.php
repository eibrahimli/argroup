							...
							<ul>	
								...
								<li data-index="rs-3042" data-transition="slideoverhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb="images/main-slider/slide4.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="FIRESTOP" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
									...
									<div class="tp-caption BigBold-Title tp-resizeme" 
										...
										style="z-index: 6; white-space: nowrap;">FIRESTOP
									</div>
									<!-- LAYER NR. 3 -->
									<div class="tp-caption BigBold-SubTitle  " 
										...
										style="z-index: 7; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;">Firestop - Yanğından qabaqcıl müdafiə həllərimizdə ən müasir texnologiyalardan istifadə edirik.
									</div>
									<!-- LAYER NR. 4 -->
									<div class="tp-caption BigBold-Button rev-btn " 
										...
										style="z-index: 8; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">ƏTRAFLI BAX
									</div>
									<!-- LAYER NR. 5 -->
									<div class="tp-caption BigBold-Button rev-btn " 
										...
										style="z-index: 9; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;"><i class="fas fa-chevron-right"></i> 
									</div>
								</li>
								<!-- SLIDE  -->
								<li data-index="rs-3043" data-transition="slideoverhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb="images/main-slider/slide5.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="VIBROTEST " data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
									<!-- MAIN IMAGE -->
									...
									<div class="tp-caption BigBold-Title   tp-resizeme" 
										...
										style="z-index: 11; white-space: nowrap;">VIBROTEST
									</div>
									<!-- LAYER NR. 8 -->
									<div class="tp-caption BigBold-SubTitle  " 
										...
										style="z-index: 12; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;">Tikililərdə mövcud olan bütün titrəşim (vibrasiya) problemlərini xüsusi test cihazı vasitəsi ilə təsbit edirik.
									</div>
									<!-- LAYER NR. 9 -->
									<div class="tp-caption BigBold-Button rev-btn " 
										...
										style="z-index: 13; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">ƏTRAFLI BAX
									</div>
									<!-- LAYER NR. 10 -->
									<div class="tp-caption BigBold-Button rev-btn " 
										...
										style="z-index: 14; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;"><i class="fas fa-chevron-right"></i> 
									</div>
								</li>
								<!-- SLIDE  -->
							</ul>
				...
				<div class="row spno about-industry">
					...
					<div class="col-lg-4 bg-white wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
						<div class="service-box style2">
							<div>
								<h2 class="title text-black"><span>Sizin </span> <br/>Həlledici Tərəfdaşınız</h2>
								<p>Yerli və beynəlxalq standartlara tam cavab verən keyfiyyətli xidmətimiz işimizin imzasıdır.</p>
								<a href="#" class="site-button outline outline-2 btnhover11">HAQQIMIZDA</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 bg-secondry text-white wow fadeIn" data-wow-duration="2s" data-wow-delay="0.8s">
						<div class="service-box style2">
							<div>
								<h2 class="title"><span>İllərin təcrübələrini </span> <br/>Birləşdirdik.</h2>
								<p>İşlərimizdə qabaqcıl markaların texnologiyalardan istifadə edirik. Həmin marka və məhsullarla daha yaxından tanış ola bilərsiniz.</p>
								<a href="#" class="site-button outline white outline-2 btnhover11">BÜTÜN MƏHSULLAR</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 bg-primary text-white wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
						<div class="service-box style2">
							<div>
								<h2 class="title">İmzaladığımız layihələrlə  <br/><span> tanış olun.</span></h2>
								<p>Tamamladığımız və hələ də davam edən layihələr saytımızda yayımlanır.</p>
								<a href="#" class="site-button outline white outline-2 btnhover11">BÜTÜN LAYİHƏLƏRƏ BAX</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
					...
					<div class="col-lg-4 bg-primary text-white wow fadeIn" data-wow-duration="2s" data-wow-delay="0.8s">
						<div class="service-box style2">
							<div>
								<h2 class="title">Məmnun müştərilərimizlə <br/><span> tanış olun.</span></h2>
								<p>Daim yenilənən müştəri portfoliomuzda sizin markanızı görməkdən məmnun olarıq.</p>
								<a href="#" class="site-button outline white outline-2 btnhover11">BÜTÜN MÜŞTƏRİLƏR</a>
							</div>
						</div>
					</div>
